...
KafkaRPC.prototype.setupResponseQueue = function(producer,topic_name, next){
    ...
    var consumer = self.connection.getConsumer('login_topic_response');
    consumer.addTopics(['signup_topic_response', 'getdirectory_topic_response', 'getactivity_topic_response', 
        'getuser_topic_response', 'updateuser_topic_response', 'createfolder_topic_response',
        'uploadfile_topic_response', 'starfile_topic_response', 'getshared_topic_response',
        'setshared_topic_response', 'deletefile_topic_response'], function (error, done) {
